...
public class Employee {
    ...
    void toString1(){
        ...
        System.out.println("Çalışanın Çalışma Saati: "+this.workHours+" Saat");
        System.out.println("Çalışanın İşe Başlangıç Yılı: "+this.hireYear);
        System.out.println("----------------");
        System.out.println("Çalışanın Verdiği Vergi: "+tax(salary)+" TL");
        System.out.println("----------------");
        System.out.println("Çalışanın Aldığı Bonus Ücret: "+bonus(workHours)+" TL");
        System.out.println("----------------");
        System.out.println("Çalışanın Aldığı Zam: "+raiseSalary(hireYear)+" TL");
        System.out.println("----------------");

        toplamMaas=this.salary+bonus(workHours)+raiseSalary(hireYear)-tax(salary);
        System.out.println("Toplam alınan Maaş: "+toplamMaas+" TL");
